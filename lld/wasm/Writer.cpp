...
void Writer::calculateCustomSections() {
  ...
  for (ObjFile *file : ctx.objectFiles) {
    for (InputChunk *section : file->customSections) {
      ...
      // blindly copied.
      // TODO: should we not have the synthesizer mark these as discarded?
...
void Writer::addSections() {
  ...
  addSection(out.codeMetadataSec);
...
void Writer::run() {
  ...
  log("-- assignIndexes");
  assignIndexes();
  // must be after assignIndexes
  out.codeMetadataSec = make<BranchHintMetadataSection>(segments);
